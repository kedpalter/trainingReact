...
const RegisterAuth = () => {
    const frmRegister = useFormik({
        ...
        onSubmit: async (userRegister) => {
            try {
                const res = await httpClientStoreApi.post(`/Users/signup`, userRegister);
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: '100vh', background: '#f0f2f5' }}>
            <div className="card p-4 shadow" style={{ width: '400px', borderRadius: '10px' }}>
                ...
                <form onSubmit={frmRegister.handleSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="number" className="form-control" id="id" name="id" placeholder="Nhập ID" />
                    </div>
                    <div className="mb-3">
