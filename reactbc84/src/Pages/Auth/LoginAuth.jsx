...
import { ACCESS_TOKEN, httpClientStoreApi, setStoreJson, setStoreText, USER_LOGIN } from '../../settings/setting'
...
const LoginAuth = () => {
  ...
  const loginForm = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // Call API đăng nhập
      try {
        const res = await httpClientStoreApi.post('/Users/signin', values);
